...
class MoralStoriesScr extends StatefulWidget {
  const MoralStoriesScr({super.key});

  @override
  State<MoralStoriesScr> createState() => _MoralStoriesScrState();
}

class _MoralStoriesScrState extends State<MoralStoriesScr> {
