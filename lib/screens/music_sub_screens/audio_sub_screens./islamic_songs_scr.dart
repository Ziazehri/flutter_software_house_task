...
class IslamicSongsScr extends StatefulWidget {
  const IslamicSongsScr({super.key});

  @override
  State<IslamicSongsScr> createState() => _IslamicSongsScrState();
}

class _IslamicSongsScrState extends State<IslamicSongsScr> {
