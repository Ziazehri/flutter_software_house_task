...
class EducationalSongs extends StatefulWidget {
  const EducationalSongs({super.key});

  @override
  State<EducationalSongs> createState() => _EducationalSongsState();
}

class _EducationalSongsState extends State<EducationalSongs> {
