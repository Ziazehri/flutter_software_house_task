...
class MotivationalSongsScr extends StatefulWidget {
  const MotivationalSongsScr({super.key});

  @override
  State<MotivationalSongsScr> createState() => _MotivationalSongsScrState();
}

class _MotivationalSongsScrState extends State<MotivationalSongsScr> {
